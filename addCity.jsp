           ...
           <section class="panel">
                    <header class="panel-heading">
             		...
             		<div class="panel-body">
                 		<form class="form-horizontal" action="${pageContext.request.contextPath }/CityController" method="post">
                 		<input type="hidden" value="insertCity" name="flag">
                   			<div class="form-group">
                                <label class="col-lg-2 col-sm-2 control-label">Country Name </label>
                                	<div class="col-lg-6">
                                	
                                        	
                                   <select id="e1" style="width:300px" name="countryId" class="populate placeholder">
           					...
           					<div class="form-group">
                                <label class="col-lg-2 col-sm-2 control-label">State Name </label>
                                	<div class="col-lg-6">
                                    	<select id="e2" style="width:300px" class="populate placeholder" name="stateId">
                            ...
                            <div class="form-group">
                                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Add City</label>
                                	<div class="col-lg-4">
